...
**CodePipeline** is an AWS software with custom actions. It supports multiple source inputs such as GitHub, AWS CodeCommit and Amazon S3. In addition, CodePipeline uses an IAM role to manage authentication that we trust artifacts build on it. 
