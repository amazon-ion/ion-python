...
@parametrize(
    ...
    _P(
        ...
        version=1,
        max_id=10,
        expected=symbols.placeholder_symbol_table(
            name=u'bar', version=1, max_id=10),
    ),
    _P(
        ...
        version=5,
        max_id=12,
        expected=symbols.substitute_symbol_table(
            FOO_4_TABLE, version=5, max_id=12),
    ),
    _P(
        ...
        max_id=7,
        expected=symbols.substitute_symbol_table(
            FOO_4_TABLE, version=3, max_id=7),
    ),
    _P(
        ...
        max_id=15,
        expected=symbols.substitute_symbol_table(
            FOO_2_TABLE, version=2, max_id=15),
    ),
    _P(
        ...
        max_id=4,
        expected=symbols.substitute_symbol_table(
            FOO_2_TABLE, version=2, max_id=4),
    ),
    _P(
...
@parametrize(
    ...
    _P(
        desc='PLACEHOLDER',
        table=symbols.placeholder_symbol_table(
            name=u'placeholder', version=1, max_id=10),
    ),
    _P(
        desc='SUBSTITUTE',
        table=symbols.substitute_symbol_table(
            FOO_4_TABLE, version=10, max_id=200),
    )
)
